...
export default function Scrollytelling() {
  ...
  // Spring that tracks the scroll closely but still glides
  const smoothProgress = useSpring(scrollYProgress, { stiffness: 200, damping: 34, mass: 0.35, restDelta: 0.0005 })

  // Text + visual cross-fades, centred on each slice boundary
  const stepOpacities = [
  ...
  return (
    <section id="how-it-works" className="relative overflow-x-clip bg-gradient-to-b from-white via-brand-50/60 to-white text-navy-900">
      ...
      {/* Scrollytelling body — 320vh track, sticky viewport */}
      <div ref={containerRef} className="relative" style={{ height: '320vh' }}>
        <div className="sticky top-0 flex h-screen items-center">
          <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[1fr_1.1fr] lg:gap-16 lg:py-10">
            {/* Step text — Desktop: absolute stacked, cross-fading */}
            ...
            {/* Visual — cross-fade on same opacities as text, always in sync */}
