...
const en: Dict = {
  ...
  'stats.statsIntro': 'Explore verified listings, happy boarders, and on-time rent collections across the island.',
  ...
  'pricing.badge': 'Landlord Plans Only',
  'pricing.title': 'Landlords, Manage Your Property with BoardEase',
  'pricing.subtitle':
    'Affordable plans designed exclusively for landlords to manage their boarding properties with ease.',
  'pricing.boarderNote':
    'Boarders can browse available rooms and properties for free. No subscription is required for boarders.',
  'pricing.mostPopular': 'MOST POPULAR',
  'pricing.perMonth': '/month',
  'pricing.getStarted': 'Get Started',
  'pricing.note': 'Landlord plans are billed monthly — upgrade, downgrade, or cancel anytime.',
  'pricing.basic': 'Basic',
  'pricing.standard': 'Standard',
  'pricing.premium': 'Premium',
  'pricing.f.boards5': 'Manage up to 5 boards',
  'pricing.f.boards15': 'Manage up to 15 boards',
  'pricing.f.boards30': 'Manage up to 30 boards',
  'pricing.f.aiAssistant': 'AI Assistant',
  'pricing.f.notifications': 'Real-time notifications',
  'pricing.f.dashboardBasic': 'Basic dashboard',
  'pricing.f.dashboardEnhanced': 'Enhanced dashboard',
  'pricing.f.dashboardAdvanced': 'Advanced dashboard',
  'pricing.f.analytics': 'Analytics',
  'pricing.f.analyticsAdvanced': 'Advanced analytics',
  'pricing.f.backup': 'Data backup',
  'pricing.f.reportsBasic': 'Basic reports',
  'pricing.f.reportsDetailed': 'Detailed reports',
  'pricing.f.reportsAdvanced': 'Advanced reports',
  'pricing.f.prioritySupport': 'Priority support',
  'pricing.f.managementControls': 'Enhanced management controls',
...
const fil: Dict = {
  ...
  'stats.statsIntro': 'Tuklasin ang mga beripikadong listing, masayang boarder, at on-time na koleksyon ng renta sa buong isla.',
  ...
  'pricing.badge': 'Mga Plano para sa Landlord Lamang',
  'pricing.title': 'Mga Landlord, Pamahalaan ang Inyong Property Gamit ang BoardEase',
  'pricing.subtitle':
    'Mga abot-kayang planong eksklusibo para sa mga landlord upang madaling pamahalaan ang kanilang boarding properties.',
  'pricing.boarderNote':
    'Libreng makakahanap ang mga boarder ng available na kuwarto at property. Walang subscription na kailangan ang mga boarder.',
  'pricing.mostPopular': 'PINAKASIKAT',
  'pricing.perMonth': '/buwan',
  'pricing.getStarted': 'Magsimula Na',
  'pricing.note': 'Buwanang sinisingil ang mga landlord plan — mag-upgrade, mag-downgrade, o magkansela anumang oras.',
  'pricing.basic': 'Basic',
  'pricing.standard': 'Standard',
  'pricing.premium': 'Premium',
  'pricing.f.boards5': 'Hanggang 5 boards ang maaaring pamahalaan',
  'pricing.f.boards15': 'Hanggang 15 boards ang maaaring pamahalaan',
  'pricing.f.boards30': 'Hanggang 30 boards ang maaaring pamahalaan',
  'pricing.f.aiAssistant': 'AI Assistant',
  'pricing.f.notifications': 'Real-time na notification',
  'pricing.f.dashboardBasic': 'Basic na dashboard',
  'pricing.f.dashboardEnhanced': 'Pinahusay na dashboard',
  'pricing.f.dashboardAdvanced': 'Advanced na dashboard',
  'pricing.f.analytics': 'Analytics',
  'pricing.f.analyticsAdvanced': 'Advanced na analytics',
  'pricing.f.backup': 'Data backup',
  'pricing.f.reportsBasic': 'Basic na report',
  'pricing.f.reportsDetailed': 'Detalyadong report',
  'pricing.f.reportsAdvanced': 'Advanced na report',
  'pricing.f.prioritySupport': 'Priority na suporta',
  'pricing.f.managementControls': 'Pinahusay na management controls',
...
const ceb: Dict = {
  ...
  'stats.statsIntro': 'Susiha ang mga verified nga listings, malipayong boarders, ug on-time nga koleksyon sa abang sa tibuok isla.',
  ...
  'pricing.badge': 'Mga Plano para sa Landlord Lamang',
  'pricing.title': 'Mga Landlord, Dumala sa Inyong Property uban ang BoardEase',
  'pricing.subtitle':
    'Barato nga mga plano nga eksklusibo para sa mga landlord aron sayon nga madumala ang ilang boarding properties.',
  'pricing.boarderNote':
    'Libre ang mga boarder sa pagpangita og available nga kwarto ug property. Wala magkinahanglan og subscription ang mga boarder.',
  'pricing.mostPopular': 'PINAKAPOPULAR',
  'pricing.perMonth': '/bulan',
  'pricing.getStarted': 'Sugdi Na',
  'pricing.note': 'Bulan-bulan nga bayranan ang mga landlord plan — mag-upgrade, mag-downgrade, o magkansela bisan unsang oras.',
  'pricing.basic': 'Basic',
  'pricing.standard': 'Standard',
  'pricing.premium': 'Premium',
  'pricing.f.boards5': 'Makadumala hangtod 5 ka boards',
  'pricing.f.boards15': 'Makadumala hangtod 15 ka boards',
  'pricing.f.boards30': 'Makadumala hangtod 30 ka boards',
  'pricing.f.aiAssistant': 'AI Assistant',
  'pricing.f.notifications': 'Real-time nga notipikasyon',
  'pricing.f.dashboardBasic': 'Basic nga dashboard',
  'pricing.f.dashboardEnhanced': 'Gipauswag nga dashboard',
  'pricing.f.dashboardAdvanced': 'Advanced nga dashboard',
  'pricing.f.analytics': 'Analytics',
  'pricing.f.analyticsAdvanced': 'Advanced nga analytics',
  'pricing.f.backup': 'Data backup',
  'pricing.f.reportsBasic': 'Basic nga report',
  'pricing.f.reportsDetailed': 'Detalyado nga report',
  'pricing.f.reportsAdvanced': 'Advanced nga report',
  'pricing.f.prioritySupport': 'Priority nga suporta',
  'pricing.f.managementControls': 'Gipauswag nga management controls',
